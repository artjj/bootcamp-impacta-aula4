...
using Teste_Scaffold_MVC.Data;
using Teste_Scaffold_MVC.Models;

namespace Teste_Scaffold_MVC.Controllers
{
    [Controller]
    [Route("[controller]")]
    public class MoviesController : Controller
    {
        private readonly Teste_Scaffold_MVCContext _context;

        public MoviesController(Teste_Scaffold_MVCContext context)
        {
            _context = context;
        }
